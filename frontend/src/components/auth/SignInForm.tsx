        ...
        <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full cursor-pointer rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-semibold p-4 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="py-17.5 px-26 text-center">
            ...
            <p className="2xl:px-20 mb-4">
              Sistema de Monitoreo de Calidad del Aire - VRISA
            </p>
